...
to setup
  ...
  ifelse time_option = 3 [
    set threshold 0.7137
    set threshold2 0.3830
  ][
    ifelse time_option = 7 [
      set threshold 0.7060
      set threshold2 0.3736
    ][
      ifelse time_option = 14 [
        set threshold 0.7770
        set threshold2 0.3628
      ][
        set threshold 0.8279
        set threshold2 0.4011
      ]
    ]
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="experiment-arrival and data sharing" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="70"/>

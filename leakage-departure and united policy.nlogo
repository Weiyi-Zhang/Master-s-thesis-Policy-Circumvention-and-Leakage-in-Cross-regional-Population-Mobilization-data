...
to go
  ...
  ask new_turtles[
    ifelse [risk] of departure = 0 [ ;;非涉疫城市出发
      move-to destination
    ][ ;;涉疫城市出发，则无论目的地，都要选择是否避难和去哪避难
      set give_up_traveler give_up_traveler + 1 ;;计入放弃出行的出行者数量
      die ;;但由于不再有可充当避难所的城市，涉疫城市出发的出行者只能放弃
    ]
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="experiment-departure and united policy" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="70"/>

...
to setup
  ...
  ifelse time_option = 3 [
    set threshold 0.5953
  ][
    ifelse time_option = 7 [
      set threshold 0.5744
    ][
      ifelse time_option = 14 [
        set threshold 0.6000
      ][
        set threshold 0.5755
      ]
    ]
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="experiment-departure and data sharing" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="70"/>
